  ...
  return (
    <div className='space-y-8'>
      ...
      <div>
        ...
        <FaFacebookF className='text[#3B599C] bg-gray-200 p-1 rounded-full text-xl'/>Facebook
        </Link>

        <Link className='flex items-center gap-2 border-x px-2 py-3 font-medium rounder hover:text-blue-500'>
        <FaTwitter className='text-[#58A7DE] bg-gray-200 p-1 rounded-full text-xl'/>Twitter
        </Link>

        <Link className='flex items-center gap-2 border px-2 py-3 font-medium rounded-b-md mb-4 hover:text-blue-500'>
        <FaInstagram className='text-orange-600 bg-gray-200 p-1 rounded-full text-xl'/>Instagram
        </Link>
